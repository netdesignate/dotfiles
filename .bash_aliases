...
alias cdduval='cd /srv/storage/DRM/'
...
alias drmdev='/srv/storage/DRM/dev'
alias cdgold='cd /srv/storage/Shared/LRH-Gold/'
alias cddot='cd ~/dotfiles/'
alias lrhv2='cd /opt/lrh_search_v2 && source .venv/bin/activate && export ANTHROPIC_API_KEY="$ANTHROPIC_API_KEY_V2"'
...
alias picker='cd /opt/image_picker && source .venv/bin/activate'
